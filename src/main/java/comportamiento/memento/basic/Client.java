package comportamiento.memento.basic;
...
public class Client {
    ...
    public  static  void main (String[]args){
        ...
        careTaker.addMemento(originator.createMemento()); //  creando mi version/comportamiento.state 1  [1]
        ...
        originator.setState(concreteObjeto);
        careTaker.addMemento(originator.createMemento()); //  creando mi version/comportamiento.state 1  [2]
