package comportamiento.memento.example;
...
public class Client {
    ...
    public  static  void main (String[]args){
        ...
        git.addMemento(originator.createMemento(),"commit version1"); //  creando mi version/comportamiento.state 1  [commit version1]
        ...
        originator.setState(estudianteAPI);
        git.addMemento(originator.createMemento(), "commit version2"); //  creando mi version/comportamiento.state 1  [commit version2]
